...
<!-- SIDEBAR -->
				...
				<div class="sidebar-background" >
					...
					<div class="left-menu">
						...
						<a  href="adm-page.jsp?pgprt=1"><h2>Accounts</h2></a>
                                                <a class="active" href="adm-page.jsp?pgprt=2"><h2>Results</h2></a>
					</div>
				</div>
        ...
        <%--<form action="prof-page.jsp" style="margin-left: 10%">
        ...
        <% 
            ArrayList list1=pDAO.getUserFullName();
            
            for(int i=0;i<list1.size();i=i+2){
        %>
        <option value="<%=list1.get(i)%>"><%=list1.get(i)%> <%=list1.get(i+1)%></option>
            <%
            }
            %>
            </select>
    ...
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded-q2">Mark</th>
    ...
    <tbody>
        ...
        <%
            ArrayList list=pDAO.getAllResults();
    	...
    	<tr>
            ...
            <% } %>
            <td><a href="adm-page.jsp?pgprt=2&eid=<%=e.getExamId()%>">Details</a></td>
        </tr>
