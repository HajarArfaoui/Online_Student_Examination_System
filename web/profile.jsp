...
<%
        ...
        %>
         <!-- SIDEBAR -->
				...
				<div class="sidebar-background" >
					...
					<div class="left-menu">
						...
						<a href="adm-page.jsp?pgprt=1"><h2>Accounts</h2></a>
                                                <a href="adm-page.jsp?pgprt=2"><h2>Results</h2></a>
					</div>
				</div>
			</div>
            <!-- CONTENT AREA -->
           ...
           else if(user.getType().endsWith("professor")){
        %>
         <!-- SIDEBAR -->
			<div class="sidebar" >
				<div class="sidebar-background" >
					...
					<div class="left-menu">
						<a class="active" href="prof-page.jsp?pgprt=0"><h2>Profile</h2></a>
						<a href="prof-page.jsp?pgprt=2"><h2>Courses</h2></a>
                                                <a href="prof-page.jsp?pgprt=3"><h2>Questions</h2></a>
					</div>
				</div>
			</div>
            <!-- CONTENT AREA -->
           ...
           <div class="profile ">
               ...
               %>
               <br/>
               <a href="adm-page.jsp?pgprt=0&pedt=1"><span class="add-btn">Edit </span></a>
               <% 
               }else if(user.getType().equals("professor")){
               %>
               <br/>
               <a href="prof-page.jsp?pgprt=0&pedt=1"><span class="add-btn">Edit </span></a>
               <%} else {
               %><br/>
               <a href="std-page.jsp?pgprt=0&pedt=1"><span class="add-btn">Edit </span></a>
               <% 
               }
               %>
