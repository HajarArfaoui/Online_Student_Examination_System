        ...
        <%
           if(session.getAttribute("examStarted")!=null){
               if(session.getAttribute("examStarted").equals("1")){
                %>
                <span id="remainingTime" style="position: fixed;top:90px;left: 300px;font-size: 23px;color: white;background: rgba(255,0,77,0.38);border-radius: 5px;padding: 10px;box-shadow: 2px -2px 6px 0px;">
        </span>
...
if(sec==0){
    ...
    time--;
               ...
               <form id="myform" action="controller.jsp">
                   ...
                   <input type="submit" class="add-btn" value="Done" name="send">
               </form>
