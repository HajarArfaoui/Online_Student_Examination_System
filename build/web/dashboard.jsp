        ...
        <% 
           if(session.getAttribute("userStatus")!=null){
            ...
            if(pDAO.getUserType(session.getAttribute("userId").toString()).equals("admin")){
                request.setAttribute("userLogin", session.getAttribute("userStatus").toString());
              response.sendRedirect("adm-page.jsp?pgprt=0"); 
                ...
                else if(pDAO.getUserType(session.getAttribute("userId").toString()).equals("professor")){
                response.sendRedirect("prof-page.jsp?pgprt=0");
